...
@section('content')
<div
    class="mx-auto max-w-[1500px] space-y-5"
    x-data="{
        selected: [],
        selectAllPage: false,
        showBulkModal: false,
...
>
                ...
                <label class="block">
                    ...
                    >
                        ...
                        @foreach (['cold', 'warm', 'hot'] as $temperature)
                            <option
                                value="{{ $temperature }}"
                                @selected(request('temperature') === $temperature)
                            >
                                {{ ucfirst($temperature) }}
                            </option>
                        @endforeach
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($leads as $lead)
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3">
                                <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-semibold capitalize {{ $priorityClass }}">
                                    {{ $lead->priority }}
                                </span>
                            </td>
    ...
    >
        <div
            class="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-xl bg-white shadow-2xl"
