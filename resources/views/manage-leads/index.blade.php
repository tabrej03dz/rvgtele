...
>
    <div class="modal-card">
        ...
        <form
            method="POST"
            action="{{ route('manage.leads.bulk-delete') }}"
            class="selected-form"
            id="bulkDeleteForm"
        >
            ...
            <label class="field">
                ...
                >
                    ...
                    <option value="lead_only">
                        Delete Lead Only
                    </option>

                    <option value="with_related">
                        Delete Lead + All Related Records
                    </option>
            ...
            <div class="flash flash-error">
                Lead + All Related Records permanently delete hoga aur undo nahi hoga.
            </div>
