    ...
    <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        >
            ...
            <input
                ...
                class="rounded-lg border border-slate-300 px-4 py-2.5 text-sm focus:border-indigo-500 focus:ring-indigo-500"
            >
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full min-w-[1200px] text-sm">
                ...
                <thead class="bg-slate-50">
                    ...
                    <tr class="border-b text-left text-xs font-semibold uppercase tracking-wide text-slate-500">
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                @if(
                                    ...
                                    <form
                                        ...
                                        onsubmit="return confirm('Is company ko remove karna hai?');"
                                    >
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <button
                                            type="submit"
                                            class="rounded-lg border border-rose-200 bg-rose-50 px-3 py-2 text-xs font-semibold text-rose-600 hover:bg-rose-100"
                                        >
                                            Delete
                                        </button>
