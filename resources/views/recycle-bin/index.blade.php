...
<style>
    ...
    .recycle-card {
        ...
        border-radius: 13px;
        box-shadow: 0 6px 20px rgba(30, 40, 80, .06);
        margin-bottom: 12px;
    }
    ...
    .recycle-tab.active {
        ...
        box-shadow: 0 6px 14px rgba(91, 77, 247, .20);
    }
    ...
    .recycle-tab.active .recycle-count {
        color: #fff;
...
@php
    ...
    $tableLabel = function (string $table): string {
    ...
    $columnLabel = function (string $column): string {
        return \Illuminate\Support\Str::headline($column);
    };
...
<div class="recycle-page">
    ...
    @if(session('success'))
        <div class="recycle-message recycle-success">
            {{ session('success') }}
        </div>
    @endif

    @if(session('error'))
        <div class="recycle-message recycle-error">
            {{ session('error') }}
        </div>
    @endif
    ...
    <section class="recycle-card recycle-header">

        <div class="recycle-header-left">
            ...
            <div>
                <h1 class="recycle-title">
                    Recycle Bin
                </h1>

                <div class="recycle-subtitle">
                    Restore soft deleted records or permanently remove them from database.
                </div>
            </div>
    ...
    <section class="recycle-card">
        ...
        <div class="recycle-tabs">
            ...
            @forelse($tables as $table)
                ...
                <a
                    href="{{ route('recycle-bin.index', $params) }}"
                    class="recycle-tab {{ $selectedTable === $table ? 'active' : '' }}"
                >

                    {{ strtoupper($tableLabel($table)) }}

                    <span class="recycle-count">
                        {{ $tableStats[$table] ?? 0 }}
                    </span>
        ...
        <section class="recycle-card">
            ...
            <div class="recycle-toolbar">
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="recycle-btn recycle-btn-primary"
                    >
                        SEARCH
                    </button>
            ...
            <div class="recycle-table-wrapper">
                        ...
                        @forelse($records as $record)
                            ...
                            <tr>
                                ...
                                @foreach($columns as $column)
                                    ...
                                    <td
                                        class="{{ $column === 'deleted_at' ? 'deleted-date' : '' }}"
                                        title="{{ is_scalar($value) ? $value : '' }}"
                                    >

                                        <div
                                            class="
                                                recycle-value
                                                {{ $column === 'id' ? 'recycle-record-id' : '' }}
                                            "
                                        >
                                ...
                                <td>
                                    ...
                                    <div class="record-actions">
                                        ...
                                        <form
                                            ...
                                            onsubmit="return confirm('Is record ko restore karna hai?');"
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class="recycle-btn recycle-btn-success recycle-mini"
                                            >
                                                ↶ RESTORE
                                            </button>
                                        ...
                                        <form
                                            ...
                                            onsubmit="return confirm('WARNING: Ye record database se permanently delete ho jayega. Is action ko undo nahi kiya ja sakta. Continue?');"
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class="recycle-btn recycle-btn-danger recycle-mini"
                                            >
                                                🗑 DELETE
                                            </button>
                            ...
                            <tr>
                                ...
                                <td colspan="{{ count($columns) + 2 }}">
                                    ...
                                    <div class="recycle-empty">
                                        ...
                                        <div class="recycle-muted">
                                            Is table me koi soft deleted record nahi hai.
                                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    if (bulkRestoreBtn) {
        ...
        bulkRestoreBtn.addEventListener(
            'click',
            function () {
