...
<div class="demo-board space-y-4">
    ...
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <div class="flex items-center gap-2">
                <i data-lucide="map-pin" class="h-6 w-6 text-amber-500"></i>
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('demo-cities.edit', $demoCity) }}" class="demo-btn demo-btn-yellow">
                <i data-lucide="upload"></i>
                Upload / Manage
            </a>

            @if($media->isNotEmpty())
                <a href="{{ route('demo-cities.download-all', $demoCity) }}" class="demo-btn demo-btn-dark">
    ...
    <div class="demo-stat-grid">
        ...
        <div class="demo-stat">
            ...
            <div>
                <div class="demo-stat-label">Total Files</div>
                <div class="demo-stat-value">{{ $media->count() }}</div>
            </div>
        </div>
        ...
        <div class="demo-stat">
            ...
            <div>
                <div class="demo-stat-label">Images</div>
                <div class="demo-stat-value">{{ $images }}</div>
            </div>
        </div>
        ...
        <div class="demo-stat">
            ...
            <div>
                <div class="demo-stat-label">Videos</div>
                <div class="demo-stat-value">{{ $videos }}</div>
            </div>
        </div>
        ...
        <div class="demo-stat">
            ...
            <div>
                <div class="demo-stat-label">Last Updated</div>
                    ...
                    <div class="media-card">
                        ...
                        <div class="media-info">
                            ...
                            <div class="media-meta">
                                ...
                                •
                                {{ number_format(($item['size'] ?? 0) / 1024 / 1024, 2) }} MB
                            </div>

                            <div class="mt-3 flex gap-2">

                                <a
                                    href="{{ route('demo-cities.media.download', [$demoCity, $item['id']]) }}"
                                ...
                                <form
                                    method="POST"
                                    action="{{ route('demo-cities.media.destroy', [$demoCity, $item['id']]) }}"
                                    onsubmit="return confirm('Delete this demo file?')"
                                >
                                    @csrf
                                    @method('DELETE')

                                    <button type="submit" class="demo-btn demo-btn-red">
    ...
    <div class="demo-shell border-rose-100 p-5">
        ...
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <form
                method="POST"
                action="{{ route('demo-cities.destroy', $demoCity) }}"
                onsubmit="return confirm('Delete city and ALL demo files permanently?')"
            >
                @csrf
                @method('DELETE')
